...
- **Single 3MF** (recommended): one file carrying all five meshes as parts of one object, with display colors from your palette and — for Bambu Studio / OrcaSlicer — filaments pre-assigned per part (colors → AMS slots 1–4, core → slot 1) via the slicer config embedded in the package. Other slicers open it as five correctly placed colored objects.
